...
import { User, Mail, Calendar, Shield, Loader2, Camera, Lock, Crown } from 'lucide-react';
...
export default function HeadmasterProfilPage() {
        ...
        <Card className="border border-border shadow-none lg:col-span-1 overflow-hidden">
          ...
          <CardContent className="pt-0 pb-5 text-center -mt-8">
            ...
            <div className="flex items-center justify-center gap-1.5 mt-1.5">
              ...
              <Badge className="text-[9px]" variant="outline">Direktur</Badge>
            </div>
            ...
            <div className="mt-4 pt-3 border-t border-border">
              <div className={`status-indicator mx-auto w-fit ${user?.status_aktif ? 'status-aktif' : 'status-nonaktif'}`}>
                {user?.status_aktif ? 'Status Direktur Aktif' : 'Status Nonaktif'}
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <Card className="border border-border shadow-none">
            ...
            <CardContent className="px-5 pb-4">
              <div className="data-grid grid-cols-1 sm:grid-cols-2 gap-x-8">
                ...
                <Field label="Role" value="Direktur (Headmaster)" />
